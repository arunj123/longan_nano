...
lib_components = {}
for component_name in ['debug_uart0', 'system',]:
...
COMPONENTS = { 
    ...
    **lib_components,
    "application": {
        "c_sources": [],
        "cpp_sources": [r"gd32v_lcd/src/main.c", r"gd32v_lcd\src\fatfs\ff.c",
                        r"gd32v_lcd\src\fatfs\ffsystem.c", r"gd32v_lcd\src\fatfs\ffunicode.c",
                        r"gd32v_lcd\src\fatfs\tf_card.c", r"gd32v_lcd\src\lcd\lcd.c"],
        "asm_sources": [],
