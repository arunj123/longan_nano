...
// --- Crisp 5x7 ASCII Bitmap Font for On-Device Diagnostics ---
...
static void draw_char(int x, int y, char c, uint16_t fg, uint16_t bg = 0x0000) {
...
static void draw_string(int x, int y, const char* str, uint16_t fg, uint16_t bg = 0x0000) {
    while (*str) {
